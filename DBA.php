    ...
    <div class="main-container">
		...
		<table>
			...
			?>
				<tr>
			<?php
						echo "<div><th>" . "SQL database uptime (site will not work if down)" .  "</th>" . "<th> " . "MONGODB uptime (will indicate if down)</th>" . "</div>";
			?>
			</tr>
			</div>
			<?php
				...
				while ($row = mysqli_fetch_assoc($results))
					{
						...
						<div class="row">
					<?php
			echo "<TD>" . secondsToTime($row["Value"]) . "</TD><TD>" . $mongodbtime . "</TD>";
					?>
